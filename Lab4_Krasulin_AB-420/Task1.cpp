...
private:
    ...
    int initialCount, maxCount, generationCount;
};
...
// spinlock (атомарного флага) для синхронизации.
...
// spinlock и yield для уменьшения нагрузки на процессор.
